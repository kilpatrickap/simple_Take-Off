...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/images/sort-alphabet.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.pushButton_sort.setIcon(icon)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/images/table-excel.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.pushButton_exportToExcel.setIcon(icon1)
        ...
        self.pushButton_exportToPdf.setIcon(icon2)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/images/printprev.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.pushButton_printPreview.setIcon(icon3)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/images/x-circle-duotone.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
