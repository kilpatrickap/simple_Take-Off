...
class Tab_nr_Widget(QtWidgets.QWidget):
    def __init__(self):
        ...
        self.groupBox_nr.setGeometry(QtCore.QRect(10, 10, 790, 501))
    ...
    def retranslateUi(self):
        ...
        item.setText(_translate("tabWidget_nr", "description"))
    ...
    def on_resize(self, event):
        ...
        if screen_width < 1920 or screen_height < 1080:
            ...
            current_geometry = self.groupBox_nr.geometry()
            ...
            self.groupBox_nr.setGeometry(new_geometry)
        ...
        for col, width in enumerate(column_widths):
            self.tableWidget_nr.setColumnWidth(col, width)
